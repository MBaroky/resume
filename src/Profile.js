...
function Profile({content}) {
    ...
    <div className="col-md-4" id="card-warpper">
        <div id="card-top">
            <a className="btn btn-dark d-md-none" role="button" id="sidebarToggleTop"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" className="bi bi-list">
