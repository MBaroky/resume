    ...
    <section id='about' className='p-lg-4'>
      <div className='card bg-transparent p-4 border-0'>
        ...
        <div className='card-body px-0'>
          <ul>
            <li>
              Passionate and innovative, self educated Web Designer /
              Front End Developer, with sufficient knowledge in both
              fields of Designing and Coding.
              <br />
            </li>
            <li>
              9 years of Experience in the web career, 6 of them as a
              UI developer using HTML, CSS and Javascript.
              <br />
            </li>
            <li>
              Studied ReactJS (FWD Advanced track Graduate) and
              Computer Science introduction (Cambridge University
              CS50) also worked as Freelancer with Wordpress.
              <br />
            </li>
            <li>
              Ambitious, self critic and a good team player, always
              ready to take the lead and responsibility for the
              co-work and willing to elevate my proficiency, by
              learning new things and sharing knowledge with fellow
              colleagues.
              <br />
            </li>
          </ul>
