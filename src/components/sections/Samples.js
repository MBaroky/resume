                    ...
                    <div>
                        <ul className="nav nav-pills nav-fill" role="tablist">
                            <li className="nav-item" role="presentation">
                                <a className="nav-link active" role="tab" data-bs-toggle="pill" href="#tab-1">Screenshots</a>
                            </li>
                                ...
                                <div className="row photos gallery">
                                    <div className="col-sm-6 col-md-4 col-lg-3 item">
                                        <a href="#">
                                            ...
                                            <LightBox alt="alt-text"  src="./assets/img/desk.jpg?h=a1a264780537cd5ef55acbd34afb098f">
                                                <img alt="alt-text"  className="img-fluid" src="./assets/img/desk.jpg?h=a1a264780537cd5ef55acbd34afb098f" />
                                            </LightBox>
                                        </a>
